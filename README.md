...
| PATCH | `/users/me` | Приватний | Оновлення імені та/або аватара поточного користувача (`multipart/form-data`) |
...
2. Auth — готово
3. User — готово, включно з `PATCH /users/me`
4. Articles — готово, включно з фільтрами/сортуванням
5. Swagger-документація — готово (`/api-docs`)
6. Додаткове оновлення інформації користувача — готово
